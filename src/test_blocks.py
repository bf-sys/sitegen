...
"""
            ...
            self.assertEqual(BlockType.HEADING, type_list[1])
            self.assertEqual(BlockType.HEADING, type_list[2])
            self.assertEqual(BlockType.HEADING, type_list[3])
            self.assertEqual(BlockType.HEADING, type_list[4])
            self.assertEqual(BlockType.HEADING, type_list[5])
            self.assertEqual(BlockType.HEADING, type_list[6])
